...
class PersonalityUI:
    ...
    def create_components(self) -> None:
        ...
        self.voice_dropdown = gr.Dropdown(label="Voice", choices=["Aiden"], value="Aiden")
    ...
    def wire_events(self, handler: Any, blocks: gr.Blocks) -> None:
        ...
        async def _fetch_voices(selected: str) -> dict[str, Any]:
            try:
                ...
                return gr.update(choices=["Aiden"], value="Aiden")
        ...
        def _save_personality(
            ...
            try:
                ...
                (target_dir / "voice.txt").write_text((voice or "Aiden").strip() + "\n", encoding="utf-8")
